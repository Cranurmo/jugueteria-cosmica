...
class PageAlta {
    ...
    static validators = {
        ...
        'price': /^[0-9]*[0-9\.\,]{1,10}$/,
        'stock':  /^[0-9]*[0-9]{1,10}$/,
        'brand': /^[\wáéíóúüÁÉÍÓÚÜ .,-]{1,30}$/,
        'category': /^[a-zA-ZÀ-ÿ]+[a-ÿz]{3,50}$/,
        'description': /^[\wáéíóúüÁÉÍÓÚÜ ¿?¡!.,:-]{1,200}$/,
        'longDescription': /^[a-zA-ZÀ-ÿ]+[a-ÿz]{3,2000}$/,
        'ageD':  /^[0-9]*[0-9]{1,10}$/,
        'ageU':  /^[0-9]*[0-9]{1,10}$/,
    };
    ...
    static async addTableEvents() {
        ...
        const editProduct = async e => {
            ...
            const longDescription = row.querySelector('.cell-longDescription').innerHTML;
            const ageD = row.querySelector('.cell-ageD').innerHTML;
            const ageU = row.querySelector('.cell-ageU').innerHTML;
            const productToEdit = {};
            productToEdit.id = id;
            ...
            productToEdit.ageD = ageD;
            productToEdit.ageU = ageU;
